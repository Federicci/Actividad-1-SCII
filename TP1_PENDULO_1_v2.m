...
for i=1:1:(ts/deltat-1)
      ...
      delta_pp=(u(1,i)-F*valores(2,i)+m*l*valores(4,i)*valores(4,i)*sin(valores(3,i))-m*g*cos(valores(3,i))*sin(valores(3,i)))/(M+m-m*cos(valores(3,i))*cos(valores(3,i)));
      valores(2,i+1)=valores(2,i)+deltat*delta_pp;
      valores(3,i+1)=valores(3,i)+deltat*valores(4,i);
      valores(4,i+1)=valores(4,i)+deltat*(g*sin(valores(3,i))/l-delta_pp*cos(valores(3,i))/l);
end
...
xlabel('Tiempo');
ylabel('Ángulo respecto a la normal');
title('Ángulo inicial = -0.01, equilibrio inestable, comparación, m=0.01, l=1.2');
...
xlabel('Tiempo');
ylabel('Ángulo respecto a la normal');
title('Ángulo inicial = pi-0.8, equilibrio estable, comparación, m=0.5, l=12');
%se observa la divergencia del sistema linealizado
...
xlabel('Tiempo');
ylabel('Ángulo respecto a la normal');
title('Ángulo inicial = pi-0.8, equilibrio estable, comparación, m=0.01, l=0.6');
